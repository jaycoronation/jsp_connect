...
class NewsDetailsScreenNew extends StatefulWidget {
  final Posts post;

  const NewsDetailsScreenNew(this.post, {Key? key}) : super(key: key);

  @override
  _NewsDetailsScreen createState() => _NewsDetailsScreen();
}

class _NewsDetailsScreen extends BaseState<NewsDetailsScreenNew> {
  late final Posts post;
  num isLiked = 0;
  @override
  void initState() {
    post = (widget as NewsDetailsScreenNew).post;
  ...
  void castStatefulWidget() {
    widget is NewsDetailsScreenNew;
  }
}
