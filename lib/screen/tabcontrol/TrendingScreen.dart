...
class _TrendingScreen extends BaseState<TrendingScreen> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
        ...
        actions: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              alignment: Alignment.center,
              child: Image.asset(
                'assets/images/ic_birthday_light.png',
                height: 22,
                width: 22,
              ),
            ),
          ...
          GestureDetector(
            ...
            child: Stack(
              children: [
                ...
                sessionManager.getUnreadNotificationCount()! > 0
                    ? Container(
                        ...
                        child: Center(
                          child: Text(checkValidString(sessionManager.getUnreadNotificationCount().toString()),
                              maxLines: 1, style: const TextStyle(fontWeight: FontWeight.w400, color: whiteConst, fontSize: 11)),
                        ),
                      )
                    : Container(),
              ],
                        ...
                        Expanded(
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              side: BorderSide(
                                  color: isDashboard1 ? orangeNew.withOpacity(0.6) : black.withOpacity(0.6), width: 0.6, style: BorderStyle.solid),
                              shape: RoundedRectangleBorder(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: isDashboard1 ? FontWeight.w600 : FontWeight.w500,
                                  color: isDashboard1 ? orangeNew.withOpacity(0.8) : black.withOpacity(0.8),
                                  fontFamily: gilroy),
                            ),
                          ),
                        ),
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      const Text(
                                                        "Dear Jay, ",
                                                        style: TextStyle(
                                                            color: blackConst, fontWeight: FontWeight.w600, fontSize: 20, fontFamily: roboto),
                                                      ),
                                                      Container(
                                                        height: 12,
                                                      ),
                                                      const Text(
                                                        ...
                                                        style: TextStyle(
                                                            color: blackConst, fontWeight: FontWeight.w400, fontSize: 18, fontFamily: roboto),
                                                      ),
                                                      Container(
                                                        height: 22,
                                                      ),
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Material(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () {
                                                            Navigator.push(
                                                                context, MaterialPageRoute(builder: (context) => const MediaCoverageScreen()));
                                                          },
                                                          borderRadius: BorderRadius.circular(18),
                                                ...
                                                text: TextSpan(
                                                  children: <TextSpan>[
                                                    TextSpan(
                                                        text: 'Social Media',
                                                        style:
                                                            TextStyle(fontFamily: roboto, fontSize: 22, color: black, fontWeight: FontWeight.w900)),
                                                  ],
                                                ),
                                              ),
                                            )),
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child:
                                                      Image.asset("assets/images/ic_naveen_video_2.png", width: 100, height: 100, fit: BoxFit.cover),
                                                ),
                                              )
                                            ],
                                          ),
                                        ...
                                        Visibility(
                                            visible: listWhatsNew.isNotEmpty,
                                            child: Container(
                                              margin: const EdgeInsets.only(left: 12, right: 12, top: 22),
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                    ...
                                                    text: TextSpan(
                                                      children: <TextSpan>[
                                                        TextSpan(
                                                            text: "What's",
                                                            style: TextStyle(
                                                                fontFamily: roboto, fontSize: 22, color: black, fontWeight: FontWeight.w900)),
                                                        TextSpan(
                                                            text: ' New',
                                                            style: TextStyle(
                                                                fontFamily: roboto, fontSize: 22, color: black, fontWeight: FontWeight.w900)),
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(listWhatsNew[index].saveTimestamp.toString(),
                                                            style: TextStyle(
                                                                color: black, fontFamily: roboto, fontWeight: FontWeight.w400, fontSize: 14)),
                                                        Container(
                                                          height: 12,
                                                        ),
                                                        Text(
                                        ...
                                        children: [
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Text(
                                                          ...
                                                          textAlign: TextAlign.center,
                                                          style:
                                                              TextStyle(color: black, fontFamily: roboto, fontSize: 12, fontWeight: FontWeight.w500),
                                                        )
                                                      ],
                                                    ),
                                                  ),
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        Navigator.push(context, MaterialPageRoute(builder: (context) => const ActivityListScreen("What's New")));
                                                      },
                                                      child: Row(
                                                        children: [
                                                          const Text(
                                                            "See All",
                                                            style: TextStyle(
                                                                color: text_dark, fontWeight: FontWeight.w500, fontSize: 14, fontFamily: roboto),
                                                          ),
                                                          Container(
                                                            width: 4,
                                                          ),
                                                        ...
                                                        children: [
                                                          Stack(
                                                            children: [
                                                              ClipRRect(
                                                                ...
                                                                child: Image.network(
                                                                  listWhatsNew[index].featuredImage.toString(),
                                                                  width: MediaQuery.of(context).size.width,
                                                                  height: 300,
                                                                  fit: BoxFit.cover,
                                                                ),
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(listWhatsNew[index].saveTimestamp.toString(),
                                                                style: TextStyle(
                                                                    color: text_dark, fontFamily: roboto, fontWeight: FontWeight.w600, fontSize: 12)),
                                                          ),
                                                          Container(
                                                      ...
                                                      text: TextSpan(
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                              text: 'Social Media',
                                                              style: TextStyle(
                                                                  fontFamily: roboto, fontSize: 18, color: black, fontWeight: FontWeight.w600)),
                                                        ],
                                                      ),
                                                    ),
                                                    GestureDetector(
                                                          ...
                                                          Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder: (context) => CommonDetailsScreen(
                                                                      listSocial[index].id.toString(), listSocial[index].postTypeId.toString())));
                                                        },
                                                        child: Container(
                                                          decoration: BoxDecoration(
                                                            borderRadius: BorderRadius.circular(20),
                                                  ...
                                                  text: TextSpan(
                                                    children: <TextSpan>[
                                                      TextSpan(
                                                          text: 'Leadership',
                                                          style:
                                                              TextStyle(fontFamily: roboto, fontSize: 18, color: black, fontWeight: FontWeight.w600)),
                                                    ],
                                                  ),
                                                ),
                                                GestureDetector(
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: () async {
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                  builder: (context) => CommonDetailsScreen(listLeadership[index].id.toString(),
                                                                      listLeadership[index].postTypeId.toString())));
                                                        },
                                                        child: Container(
                                                            height: 220,
                                                            width: 140,
                                                              ...
                                                              children: [
                                                                ...
                                                                Positioned(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Text(
                                                                          listLeadership[index].title.toString(),
                                                                          style: TextStyle(
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) => CommonDetailsScreen(
                                                                  listEvents[index].id.toString(), listEvents[index].postTypeId.toString())));
                                                    },
                                                    child: Container(
                                                      decoration: BoxDecoration(
                                                        borderRadius: BorderRadius.circular(20),
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                listEvents[index].location.toString().isNotEmpty
                                                                    ? Container(
                                                                        width: 12,
                                                                      )
                                                                    : Container(),
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: ClipRRect(
                                                              ...
                                                              child: Image.network(
                                                                "https://res.cloudinary.com/dliifke2y/image/upload/v1669291684/Naveen%20Jindal/_SAM9144_kqf6wa.jpg",
                                                                fit: BoxFit.cover,
                                                              ),
                                                            ),
                                                          ),
                                                ...
                                                Positioned(
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(color: border.withOpacity(0.8)),
                                                        child: Row(
                                                          crossAxisAlignment: CrossAxisAlignment.center,
                                                          ...
                                                          children: const [
                                                            Text(
                                                              "View All",
                                                              style: TextStyle(
                                                                  color: whiteConst, fontFamily: roboto, fontSize: 14, fontWeight: FontWeight.w500),
                                                            ),
                                                            Icon(
                                                              Icons.arrow_forward_ios,
                                                              color: whiteConst,
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) => CommonDetailsScreen(
                                                                  listNews[index].id.toString(), listNews[index].postTypeId.toString())));
                                                    },
                                                    child: Container(
                                                      decoration: BoxDecoration(
                                                        borderRadius: BorderRadius.circular(20),
                                                          ...
                                                          Stack(
                                                            children: [
                                                              ClipRRect(
                                                                borderRadius: BorderRadius.circular(20),
                                                                child: Image.network(
                                                                  listNews[index].featuredImage.toString(),
                                                                  width: MediaQuery.of(context).size.width,
                                                                  height: 180,
                                                                  fit: BoxFit.cover,
                                                                ),
                                          ...
                                          GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: border),
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                children: const [
                                                  Text(
                                                    ...
                                                    style:
                                                        TextStyle(color: whiteConst, fontWeight: FontWeight.w600, fontSize: 16, fontFamily: roboto),
                                                  ),
                                                  Icon(
                                                    Icons.arrow_forward_ios,
                                                    color: whiteConst,
                                                ...
                                                return GestureDetector(
                                                  onTap: () {
                                                    Navigator.push(
                                                        ...
                                                        MaterialPageRoute(
                                                            builder: (context) => CommonDetailsScreen(
                                                                listVideos[index].id.toString(), listVideos[index].postTypeId.toString())));
                                                  },
                                                  child: Stack(
                                                    children: [
                                                      SizedBox(
                                                        ...
                                                        child: ClipRRect(
                                                          borderRadius: BorderRadius.circular(12),
                                                          child: Image.network(
                                                            listVideos[index].featuredImage.toString(),
                                                            fit: BoxFit.cover,
                                                          ),
                                                        ),
                                                      ),
  ...
  Widget _buildChip(String label) {
    return Chip(
      ...
      label: Text(
        label,
        style: const TextStyle(color: border, fontFamily: roboto, fontSize: 12, fontWeight: FontWeight.w500),
      ),
